...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Bosphore GROUP - <?php echo e(trans('messages.pagetitle')); ?></title>
...
<div class="container">
  <div class="row">
      <div class="col-8 mx-auto mt-5 text-center" >
        <form action='/ihracat/operasyon/file/upload' method="post"  enctype="multipart/form-data" name='a'>
          ...
          <input type='hidden' name="talimatId" value="<?php echo e($id); ?>" />
          <button class='btn btn-info' type='submit'><?php echo e(trans("messages.dosyayuklekaydet")); ?></button>
        </form>
      </div>
