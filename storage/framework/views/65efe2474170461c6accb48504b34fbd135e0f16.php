            ...
            <!-- /.box-header -->
                <div class="box-body">
                  <div class="form-group">
                        <label for="messageUserTO"><?php echo e(trans('messages.remembertouser')); ?></label>
                        <select class="form-control" id="messageUserTO" name='userTo' required="required">
                          ...
                          <?php if(!empty($users)): ?>
                          	...
                          	<option value="<?php echo e($val['id']); ?>" <?php if(!empty($touser)): ?> <?php if($val['id']==$touser): ?> selected='selected' <?php endif; ?> <?php endif; ?>><?php echo e($val['name']); ?> (<?php echo e($val['email']); ?>)</option>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name='messageTitle' value="Ce:<?php echo e($orjinalMesaj->mesajTitle); ?>" id="messageControlTitle" placeholder="<?php echo e(trans('messages.messagetitle')); ?>"  required="required">
                  </div>
                  <div class="form-group alert alert-info">
                    <hr />
                       <?php echo e(trans('messages.orginalMessage')); ?>

                      <br/>
                      <?php echo $orjinalMesaj->mesajIcerigi; ?>
