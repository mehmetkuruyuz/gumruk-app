...
function appendFormData()
{
	...
	function validateForm()
	{
		...
		if (firmaid==0)
		{
			alert("<?php echo e(trans("messages.bosolamazalert")); ?>");
			return false;
		}
                ...
                <label for="cekiciPlaka"><?php echo e(trans("messages.cekiciplaka")); ?></label>
                    <input type="text" class="form-control" name='cekiciPlaka' id="cekiciPlaka">
							  ...
							  <div class='row'>
								...
								<div class="form-group col-md-4 temizlenebilir">
									<label for="pozisyonNo"><?php echo e(trans("messages.pozisyonNo")); ?></label>
											<input type="text" class="form-control" name='pozisyonNo' id="pozisyonNo">
								</div>
			 				</div>
							<div class='row'>
								<div class="form-group col-md-4 temizlenebilir">
									<label for="teminatTipi"><?php echo e(trans("messages.teminatTipi")); ?></label>
									<select name='teminatTipi' class="form-control" id="teminatTipi">
										<option value='0'>(<?php echo e(trans("messages.choose")); ?>)</option>
										<option value="SGS"><?php echo e(trans("messages.SGS")); ?></option>
										<option value="TOBB"><?php echo e(trans("messages.TOBB")); ?></option>
										<option value="MARS"><?php echo e(trans("messages.MARS")); ?></option>

									</select>
								</div>
								<div class="form-group col-md-4 temizlenebilir">
									<label for="tasimaTipi"><?php echo e(trans("messages.tasimaTipi")); ?></label>
									<select name='tasimaTipi' class="form-control" id="tasimaTipi">
										<option value='0'>(<?php echo e(trans("messages.choose")); ?>)</option>
										<option value="gemi"><?php echo e(trans("messages.gemi")); ?></option>
										<option value="tren"><?php echo e(trans("messages.tren")); ?></option>
										<option value="kara"><?php echo e(trans("messages.kara")); ?></option>
									</select>
								</div>
							</div>
							<div class='row'>
								<div class="form-group col-md-4 temizlenebilir">
									<label for="sertifikano"><?php echo e(trans("messages.sertifikano")); ?></label>
									<input type="text" class="form-control" name='sertifikano' id="sertifikano">
								</div>
								<div class="form-group col-md-4 temizlenebilir">
									<label for="ozelplaka"><?php echo e(trans("messages.ozelplaka")); ?></label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="testerVX">
				<label><?php echo e(trans("messages.evrakyukle")); ?></label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="appendFormData()"><?php echo e(trans("messages.add")); ?></button>
      </div>
    </div>
  </div>
</div>
