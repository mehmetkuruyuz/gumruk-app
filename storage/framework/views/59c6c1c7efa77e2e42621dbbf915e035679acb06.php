        ...
        <div class="panel-body">
          ...
          <div class="">
            <table class="table table-bordered" cellspacing="0">
              <thead>
                <tr>
                  <th colspan="2"> 	<?php echo e(trans('messages.companyname')); ?></th>
              ...
              <tbody>
								<?php if(!empty($operasyonList)): ?>
									<?php $__currentLoopData = $operasyonList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m=>$evm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td><?php echo e($evm->cekiciPlaka); ?></td>
											<td><?php echo e($evm->dorsePlaka); ?></td>
											<td><?php echo e($evm->autoBarcode); ?></td>
											<td><?php echo e($evm->talimatTipi); ?></td>
											<td><?php echo e(\Carbon\Carbon::parse($evm->created_at)->format("d-m-Y H:i:s")); ?></td>
											<td>	<?php if(!empty($evm->bolge->name)): ?><?php echo e($evm->bolge->name); ?> <?php endif; ?></td>
											<td>	<?php if(!empty($evm->ilgili->name)): ?><?php echo e($evm->ilgili->name); ?> <?php endif; ?></td>
												<td>	<?php if(!empty($evm->ilgilikayit->name)): ?><?php echo e($evm->ilgilikayit->name); ?> <?php endif; ?></td>
											<td>
												<div style="height:120px;overflow-y:scroll;;">
													 ...
													 <?php if(!empty($evm->evrak[0])): ?>
														 <a href='/operationfiledownload/<?php echo e($evm->id); ?>' target="_blank" class="btn btn-info btn-sm"><?php echo e(trans("messages.tumunuindir")); ?></a>
                        ...
                        <?php endif; ?>
											...
											<td><a title="<?php echo e(trans("messages.print")); ?>" href='javascript:void(0)' onclick="PopupCenter('/operation/print/<?php echo e($evm->id); ?>','xtf','930','500'); "><i class="fa fa-print" aria-hidden="true" style='color:brown'></i></a></td>
											<td><a title="<?php echo e(trans("messages.show")); ?>" href='/operasyon/goster/<?php echo e($evm->id); ?>' <?php if($evm->islemdurum=='bosta' && (\Auth::user()->role=='admin' || \Auth::user()->role=='bolgeadmin' )): ?> onclick="return onaylavegit()" <?php endif; ?>><i class="fa fa-file-text" aria-hidden="true" style='color:brown'></i></a></td>
											<?php if(\Auth::user()->role=='admin' || \Auth::user()->role=='bolgeadmin'): ?>
												<td><a  title="<?php echo e(trans("messages.edit")); ?>" href='/operation/edit/<?php echo e($evm->id); ?>'><i class="fa fa-pencil" aria-hidden="true" style='color:orange'></i></a></td>
											<?php else: ?>
												<td>&nbsp;</td>
											<?php endif; ?>
											<td><a title="<?php echo e(trans("messages.uploadfile")); ?>" href='javascript:void(0)' onclick="PopupCenter('/operation/upload/<?php echo e($evm->id); ?>','xtf','930','500'); "><i class="fa fa-file-pdf-o" aria-hidden="true" style='color:orange'></i></a></td>
