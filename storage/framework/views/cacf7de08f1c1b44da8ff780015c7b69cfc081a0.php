    <table class="table table-bordered malYuklemeBosaltmaTablolari" width="100%" cellspacing="0">
      <thead>
          <tr>
            ...
            <th colspan="2"><?php echo e(trans("messages.faturabedeli")); ?></th>
          </tr>
      </thead>
      <tbody>
                <tr><td colspan="12"><?php echo e(trans("messages.".$talimattipi)); ?></td></tr>
          <tr id="sampletr<?php echo e($say); ?>" class="input-group-sm">

            <td class="d-none"><input type="radio" name="_copier[][]" value='-1'  />  </td>
