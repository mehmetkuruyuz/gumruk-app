    <table class="table table-bordered malYuklemeBosaltmaTablolari" width="100%" cellspacing="0">
      ...
      <tbody>
          ...
          <td><input type="text" class="form-control varisGumruk"  name='baslangicGumrugu[{{$say}}][]' id="" placeholder="Varış Gümrüğü"></td>
          <td><input type="text" class="form-control kolaysay" name="mrnnumber[{{$say}}][]"  size="18" maxlength="18"/></td>
          <td><input type="text" class="form-control" name="tirnumarasi[{{$say}}][]" required="required"/></td>
          <td><input type="text" class="form-control" name="yuklemeNoktasi[{{$say}}][]" required="required"/></td>
            ...
            <td><input type="text" class="form-control varisGumruk"  name='varisGumrugu[{{$say}}][]' id="" placeholder="Varış Gümrüğü"  required="required"></td>
