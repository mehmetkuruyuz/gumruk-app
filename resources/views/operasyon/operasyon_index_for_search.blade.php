...
@endif
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <form action="/operation/done" method="post" name="d" class="row" >
              {{csrf_field()}}
          ...
          <div class="col-sm-2">
            <a href='/operation/done' class="btn btn-danger">{{trans("messages.operasyontamam")}} {{trans("messages.operasyonlist")}}</a>
          </div>
								...
								@if (!empty($operasyonList))
									@foreach($operasyonList as $m=>$evm)
										<tr>
											...
											<td>{{trans('messages.'.$evm->talimatTipi)}}</td>
