        ...
        <div class="col-8 mx-auto" >
          <div class="card mb-3">
            ...
            <div class="card-body">
              <table class="table">
                <tr>
                    <td colspan="2" class="align-right text-right"><img src='/img/logo.png' class="img-fluid w-50" /></td>
               </tr>
               <tr>
                  <td colspan="2">
               ...
               <tr>
                ...
                <tr>
                  <td>{{trans("messages.odemealan")}}</td>
                  <td>  @if (!empty($data->odeme->odemealanname)){{$data->odeme->odemealanname}}        @endif</td>
                </tr>
