...
{{--
           	...
           	@else
                ...
                <label for="cekiciPlaka">{{trans("messages.cekiciplaka")}}</label>
                    <input type="text" class="form-control" name='cekiciPlaka' id="cekiciPlaka" placeholder="Araç Çekici Plaka"  required="required"  value="{{$data->cekiciPlaka}}">
                  </div>
              </div>
              <div class='row'>
                  <div class="form-group col-md-4 temizlenebilir">
                <label for="dorsePlaka">{{trans("messages.dorseplaka")}}</label>
                    <input type="text" class="form-control" name='dorsePlaka' id="dorsePlaka" placeholder="Dorse Çekici Plaka" required="required" value="{{$data->dorsePlaka}}">
                  </div>
			 				</div>
					 <div class='row'>
							 <div class="form-group col-md-4 temizlenebilir">
                			...
                			<table class="table table-bordered malYuklemeBosaltmaTablolari" width="100%" cellspacing="0">
                              ...
                              <th>{{trans("messages.talimattipi")}}</th>
                				...
                				<tbody>
													...
													@foreach ($data->params as $paramskey => $paramsvalue)

                    				<tr>
                						<td>1</td>
														<td><input type="text" class="form-control" name="mrnmumber[0][]" required="required" value="{{$paramsvalue->mrnnumber}}"/></td>
                    					<td><input type="text" class="form-control" name="yuklemeNoktasi[0][]" required="required"  value="{{$paramsvalue->yuklemeNoktasi}}"/></td>
															...
															<td><input type="text" class="form-control" name="indirmeNoktasi[0][]" required="required" value="{{$paramsvalue->indirmeNoktasi}}"/></td>
															<td>
                              ...
                              <td>
                                 @if (!empty($talimatList))
                                   <select name='talimatTipi[0][]' class="form-control" id='talimatTipi' onchange='gettalimatData(this)'>
                                    	 	@foreach($talimatList as $key=>$value)
                                            	 <option value="{{ $value->kisaKod }}" @if ($paramsvalue->talimatTipi==$value->kisaKod ) selected="selected" @endif>{{ $value->kodName }}</option>
                                      	@endforeach
                                      	 </select>
                                  @endif
                                </td>
                              <td><input type="text" class="form-control hesaplanacakKap" name="tekKap[0][]" required="required" onchange="hesaplaKapKilo(0)" value="{{$paramsvalue->tekKap}}"/></td>
            							    <td><input type="text" class="form-control  hesaplanacakKilo" name="tekKilo[0][]" required="required"  onchange="hesaplaKapKilo(0)" value="{{$paramsvalue->tekKilo}}"/></td>
															<td><input type="text" class="form-control" name="yukcinsi[0][]" required="required" value="{{$paramsvalue->yukcinsi}}"  /> </td>
															<td><input type="text" class="form-control" name="faturanumara[0][]" required="required"  value="{{$paramsvalue->faturanumara}}" /> </td>
															<td class="faturabedel"><input type="text" class="form-control " name="faturabedeli[0][]" value="{{$paramsvalue->faturabedeli}}" required="required"   /> </td>
															<td>
