...
//      \Mail::to('noreply@bosphoregroup.com')->cc($userEmail)->send(new InfoMailEvery($userFirmName,$userEmail,trans('messages.newtalimat'),$talimatMesaj)) ;
    ...
    {
      \Helper::langSet();
      $gumrukListesi = DB::table('gumrukListesi')->get();
    ...
    //    return $request;
        ...
        \Mail::to('noreply@bosphoregroup.com')->cc($userEmail)->send(new InfoMailEvery($userFirmName,$userEmail,trans('messages.talimatupdated'),$talimatMesaj)) ;
